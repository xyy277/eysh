...
public class SysHomeController {
    ...
    public String home(HttpServletRequest req) {
        return "redirect:/platform/cms/record/";
    }

    @RequestMapping("/left")
    @RequiresAuthentication
    public String left(@RequestParam(required = false, value = "url") String url, HttpServletRequest req) {
        String path = "";
        String perpath = "";
    ...
    @RequestMapping("/path")
    @RequiresAuthentication
    public String path(@RequestParam(required = false, value = "url") String url, HttpServletRequest req) {
        if (Strings.sBlank(url).indexOf("//") > 0) {
            String[] u = url.split("//");
    ...
    @RequiresAuthentication
    @SJson
    public Object submenu(@RequestParam(required = false, value = "pid") String pid, HttpServletRequest req) {
        try {
