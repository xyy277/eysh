...
/**
 * Created by zzhu on 2017/9/19.
 */
@Controller
@RequestMapping("/open/pay/wxExpertPay")
public class WxExpertPayController {
    ...
    @SJson
    public Object wxPayOrder(@RequestParam("orderId") String orderId, HttpServletRequest req){
        try{
            //创建一个wxApi2
