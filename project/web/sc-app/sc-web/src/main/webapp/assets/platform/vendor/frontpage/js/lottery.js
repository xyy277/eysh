...
function roll(){
	...
	if (lottery.times > lottery.cycle+10 && lottery.prize==lottery.index) {
		switch (lottery.prize) {
			case 0:
				$("#cjmodal .modal-body p").html("恭喜您抽中了18双创枢纽积分!");
				$("#cjmodal").modal();
				break;
			case 2:
				$("#cjmodal .modal-body p").html("恭喜您抽中了8双创枢纽积分！");
				$("#cjmodal").modal();		
				break;	
			case 3:
				$("#cjmodal .modal-body p").html("恭喜您抽中了8双创枢纽积分！");
			...
			case 5:
				...
				break;				
			case 6:
				$("#cjmodal .modal-body p").html("恭喜您抽中了288双创枢纽积分！");
				$("#cjmodal").modal();			
				break;				
			case 8:
				$("#cjmodal .modal-body p").html("恭喜您抽中了8双创枢纽积分！");
				...
				break;					
			case 9:
				$("#cjmodal .modal-body p").html("恭喜您抽中了1888双创枢纽积分！");
				$("#cjmodal").modal();			
				break;							 	 			 				 				 		 				 		
			case 10:
				$("#cjmodal .modal-body p").html("恭喜您抽中了18双创枢纽积分！");
